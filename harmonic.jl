...
struct harmonic_coordinate_transformation(DOMAIN_LB::Vector{Float64}, DOMAIN_UB::Vector{Float64}, ST::Spacetime; GRID_DIMENSIONS=Int64[50, 5, 50, 5], PRECOMPILE_INVERSE=false)
